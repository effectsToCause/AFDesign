...
inputpdb=sys.argv[1]
fixedpositions=sys.argv[2]
outputpdb=sys.argv[3]

clear_mem()
model = mk_design_model(num_models=5, model_mode= "sample", num_recycles=2, recycle_mode="average", protocol="partial", pos=fixedpositions, model_parallel=False)
